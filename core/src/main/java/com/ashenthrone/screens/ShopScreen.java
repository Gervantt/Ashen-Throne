...
public class ShopScreen extends BaseScreen {
    ...
    private static final ItemDef[] ITEMS = {
            ...
            new ItemDef(ITEM_CURSED_RING,  "Cursed Ring",  "+8 Defense, -2 Attack", 40,
                    new Color(0.55f, 0.35f, 0.65f, 1f)),
            new ItemDef(ITEM_SHADOW_BLADE, "Shadow Blade", "+10 Attack",            80,
                    new Color(0.40f, 0.40f, 0.55f, 1f)),
    };

    // ---- Layout ----
    private static final float CARD_W = 320f;
    ...
    private void drawCards() {
        ...
        for (int i = 0; i < ITEMS.length; i++) {
            ...
            // Icon block (placeholder for the item art).
            float iconW = 180f;
            float iconH = 180f;
    ...
    private static final class ItemDef {
        ...
        ItemDef(String id, String name, String effect, int cost, Color tint) {
            this.id = id;
            this.name = name;
            this.effect = effect;
            this.cost = cost;
